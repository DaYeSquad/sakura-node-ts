...
__decorate([
    decorator_1.Column('uri', model_1.SqlType.VARCHAR, model_1.SqlFlag.NOT_NULL)
], WeatherCacheInfo.prototype, "uri", void 0);
__decorate([
    decorator_1.Column('alias', model_1.SqlType.VARCHAR, model_1.SqlFlag.NOT_NULL)
...
describe('ReplaceQuery', () => {
    it('Test build', () => {
        ...
        const sql = new replacequery_1.ReplaceQuery()
            ...
            .set('uri', weatherCache.uri, model_1.SqlType.VARCHAR)
            .set('alias', weatherCache.alias, model_1.SqlType.VARCHAR)
