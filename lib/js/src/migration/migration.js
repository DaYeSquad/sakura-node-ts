...
class Migration {
    ...
    currentVersion_() {
        return __awaiter(this, void 0, void 0, function* () {
            const createTableSql = sqlgenerator_1.sqlGenerator.generateCreateTableSql(version_1.Version);
            yield this.pgInstance_.query(createTableSql);
    ...
    migrate(setupEnv = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (currentVersion === undefined) {
                ...
                const insertSql = new insertquery_1.InsertQuery().fromModel(version).build();
                yield this.pgInstance_.query(insertSql);
            }
