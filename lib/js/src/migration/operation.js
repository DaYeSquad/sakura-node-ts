...
const testsqlgenerator_1 = require('../tools/testsqlgenerator');
class Operation {
}
...
class AddTestModelOperation extends ModelOperation {
    constructor(cls) {
        super();
        this.modelClass_ = cls;
    }
    sql() {
        return testsqlgenerator_1.testSqlGenerator.generateCreateTableSql(this.modelClass_);
    }
}
exports.AddTestModelOperation = AddTestModelOperation;
