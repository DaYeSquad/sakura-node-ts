    ...
    static modelFromRow(row, type) {
        ...
        for (let sqlField of sqlFields) {
            if (sqlField.type === SqlType.TIMESTAMP) {
                instance[sqlField.name] = dateutil_1.DateUtil.millisecondToTimestamp(new Date(row[sqlField.columnName]).getTime());
            }
            else {
...
})(SqlFlag = exports.SqlFlag || (exports.SqlFlag = {}));
var SqlDefaultValueType;
...
})(SqlDefaultValueType = exports.SqlDefaultValueType || (exports.SqlDefaultValueType = {}));
